...
El problema esencialment consisteix en intentar predir la probabilitat de patir un atac de cor (variable *output*) a partir de la resta de variables. Per això hem construït diferents models mesurant la qualitat de cada un d'ells. De les diferents opcions considerades, la que millor resultats ens ha donat és l'algorisme de classificació supervisat *randomForest* amb una  taxa de predicció del `r precisio_model`%.
